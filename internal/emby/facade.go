...
import (
	...
	"github.com/flaksp/anime365-emby/internal/emby/internal/manifest"
	...
	"github.com/flaksp/anime365-emby/pkg/filename"
...
func (s *Service) GetLastWatchedEpisodeNumber(
	...
	if len(itemsResponse.Items) == 0 {
		return 0, 0, errors.New("item not found in emby user items")
	}
